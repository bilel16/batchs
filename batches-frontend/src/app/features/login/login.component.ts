...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  private initializeForm(): void {
    ...
    this.form.get('username')?.valueChanges.pipe(takeUntil(this.destroy$)).subscribe(() => {
  ...
  private handleLoginError(error: any): void {
    ...
    if (message === 'Matricule inexistante' || message === 'User not found') {
      this.usernameError = true;
      this.errorMessage = 'Identifiant invalide';
    } else if (message === 'Mot de passe invalide' || message === 'Bad credentials') {
