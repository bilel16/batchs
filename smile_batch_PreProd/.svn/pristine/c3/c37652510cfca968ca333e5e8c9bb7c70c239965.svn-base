...
public class InsertJourneeStructureBatchTrt extends Traitement{
  
    public InsertJourneeStructureBatchTrt() {
    }
       ...
       try{ 
            ...
            if(!journeeStructureBatch.equals(null)){
               crudService.create(journeeStructureBatch);    
                ...
                erreur.setDescription("InsertJourneeStructureBatchTrt  "+e.getMessage());;
