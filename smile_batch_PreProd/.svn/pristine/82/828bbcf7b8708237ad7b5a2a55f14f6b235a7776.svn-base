...
public class PrelevementDeuxiemeTrancheEpargneEtudeResiduTrt extends Traitement {

	Log logger = new Log(PrelevementDeuxiemeTrancheEpargneEtudeResiduTrt.class);
...
//				// 03. setting structure receptrice
				...
				operationMoyPayCredit.setMontDinOmp(contratFaiezVo.getMont_trch2_cat());

				operationMoyPayCredit.setMontApreOmp(contratCptBen.getMontSoldCcpt() + contratFaiezVo.getMont_trch2_cat());
				...
				// Checking Devise
				contratCptSold.setSolde(contratFaiezVo.getMont_trch2_cat());
...
//				operationMoyPayDebit.setStructureReceptrice(structureRecepD);
				...
				// 05. setting devise et montant
				operationMoyPayDebit.setMontDinOmp(contratFaiezVo.getMont_trch2_cat());

				operationMoyPayDebit.setMontApreOmp(contratCptDeb.getMontSoldCcpt() - contratFaiezVo.getMont_trch2_cat());
				...
				contratCptSoldDebit.setSolde(contratFaiezVo.getMont_trch2_cat());
				...
				assVieEpargneDAO.UpdateTraceTrancheFaiezRésiduePayée(contratFaiezVo, sysdate, 2);
			}
