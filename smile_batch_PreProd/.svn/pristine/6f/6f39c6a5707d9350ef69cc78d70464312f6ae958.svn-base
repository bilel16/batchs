 ...
 * @since 05/04/2008
 */
public class InsertPersClientTrt extends Traitement {
    public InsertPersClientTrt() {
    }
    
    /**
         * methode permettant l'insertion d'une ligne personne client
         * 
         * @param  PersClient
         * @return PersClient
         */
        ...
        PersClient persClient = (PersClient)vo;
         try{
            CRUDservice crudService = 
                ...
                StringBuffer text = 
                    new StringBuffer("Erreur dans InsertPersClientTrt : ");
