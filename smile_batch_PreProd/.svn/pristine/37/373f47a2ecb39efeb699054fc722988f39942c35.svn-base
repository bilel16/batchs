...
public class Cro842PayementBCTrt extends Traitement {
	...
	public IValueObject perform(IValueObject vo) {
		...
		try {
			...
			traitementConditionBanque.setCodOperOper("" + Constants.COD_OPERATION_PAIEMENT_BC);
			...
			operationMoyPay.setLibObjOpOmp("PAIEMENT BC ");
			...
			oper.setCodOperOper(Constants.COD_OPERATION_PAIEMENT_BC);
			Tache tache = new Tache();
			tache.setOperation(oper);
			TacheId tacheId = new TacheId();
			tacheId.setCodOperOper(Constants.COD_OPERATION_PAIEMENT_BC);
			...
			operationMoyPay.setLibMotfOmp("PAIEMENT BC");
			...
			StringBuffer text = new StringBuffer("Erreur dans Cro842PayementBCTrt : ");
			text.append(e.toString());
			erreur.setCode("100");
			erreur.setDescription(text.toString());
			erreur.setKey("Cro842PayementBCTrt");
			reglementEffetVo.addError(erreur);
			logger.error("Erreur au niveau Cro842PayementBCTrt : ", e);
	...
	public void genCroText(ValueObject vo) {
		...
		operation.setCodOperOper(Constants.COD_OPERATION_PAIEMENT_BC);
