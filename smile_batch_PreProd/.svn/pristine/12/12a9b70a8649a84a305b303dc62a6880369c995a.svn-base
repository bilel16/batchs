...
public class DebloquerContratCptTrt extends Traitement{
    public DebloquerContratCptTrt() {
    }
    ...
    public IValueObject perform(IValueObject vo) {
        ...
        try {
            ...
            /*insertion de la trace de deblocage*/
            ...
            StringBuffer text = 
                new StringBuffer("Erreur lors deblocage du contrat ");
            text.append(e.toString());
            erreur.setCode("200");
            erreur.setDescription(text.toString());
            erreur.setKey("DébloquerContrat");
    ...
    public void genererSynchronisationPascal(ValueObject vo) { 
        ...
        String numCompte = StrHandler.lpad(contratABloquer.getContratCpt().getContratCptId().getCodPrdPrd().toString(),'0',4) +
                           StrHandler.lpad(contratABloquer.getContratCpt().getContratCptId().getNumCcptCcpt().toString(),'0',6)+"N";
