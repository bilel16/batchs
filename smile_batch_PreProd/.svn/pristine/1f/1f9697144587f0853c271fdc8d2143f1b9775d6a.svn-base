...
public class GetSituationMensuelleByClientCmd implements ICommande{
    public GetSituationMensuelleByClientCmd() {
    }
    /**
         * methode execute 
        ...
        public IValueObject execute(IValueObject vo) {
            ...
            Listes situationMensuelle =(Listes)placementService.getSituationMensuelleClient(paramDemandeDecision);
