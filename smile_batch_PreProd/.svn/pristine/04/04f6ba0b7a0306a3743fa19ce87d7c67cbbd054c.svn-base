...
public class GetSituationMensuelleByStructureCmd implements ICommande{
    public GetSituationMensuelleByStructureCmd() {
    }
    /**
         * methode execute 
        ...
        public IValueObject execute(IValueObject vo) {
            ...
            Listes situationMensuelle =(Listes)placementService.getSituationMensuelle(paramDemandeDecision);
