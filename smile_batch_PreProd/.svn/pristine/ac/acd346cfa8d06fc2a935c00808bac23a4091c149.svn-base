...
import com.bna.smile.model.domaineguichet.traitement.MAJSoldesTrt;
...
public class MoulinetteMAJSOLDES extends AbstractJob {

    private static final Logger logger = 
        Logger.getLogger(MoulinetteMAJSOLDES.class);
...
//            guichetService.MAJNSI(new ValueObject());
            MAJSoldesTrt majsoldes= new MAJSoldesTrt();
