...
public class CreationCROEnvoiPrelevementsAgenceTrt extends Traitement {
	...
	public CreationCROEnvoiPrelevementsAgenceTrt() {
	}
	...
	public IValueObject perform(IValueObject vo) {
		...
		try {
			...
			StringBuffer text = new StringBuffer("Erreur dans CreationCROEnvoiPrelevementsAgenceTrt : ");
			text.append(e.toString());
			erreur.setCode("100");
			erreur.setDescription(text.toString());
			erreur.setKey("CreationCROEnvoiPrelevementsAgenceTrt");
			prelevementVo.addError(erreur);
			logger.error("Erreur au niveau CreationCROEnvoiPrelevementsAgenceTrt : ", e);
	...
	public void genCroText(ValueObject vo) {
		logger.info("starting CreationCROEnvoiPrelevementsAgenceTrt method ");
		...
		this.setLibRefCro("ENVOI DES PRELEVEMENTS COMPENSATION AGENCE INTER ET INTRA");
