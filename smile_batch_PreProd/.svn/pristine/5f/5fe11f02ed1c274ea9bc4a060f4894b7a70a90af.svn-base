...
public class SocietesAFBView implements Serializable {
	...
	public String getEmailSoctAFB() {
		return emailSoctAFB;
	}

	public void setEmailSoctAFB(String emailSoctAFB) {
		this.emailSoctAFB = emailSoctAFB;
	}
