...
import com.bna.smile.model.domainetraitementfichier.ConcatEscEncTrt;
import com.oxia.fwk.context.Context;
import com.oxia.fwk.context.ContextFactory;

public class MoulinetteConcatEncEsc  
{
	

	
	 
	  public MoulinetteConcatEncEsc( ) {
	...
	public static void main(String...strings) throws Exception {
        ...
        ContextHandler.setContext(context);
         ...
         ConcatEscEncTrt   concatTrt  = new ConcatEscEncTrt();
         concatTrt.perform(null);
         System.exit(0);
