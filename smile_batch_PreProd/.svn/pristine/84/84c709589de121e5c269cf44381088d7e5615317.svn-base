...
import com.oxia.fwk.core.IValueObject;
   ...
   * 
   */
public class RejeterLiquidationAnticipeCmd implements ICommande{
    public RejeterLiquidationAnticipeCmd () {
    }
    ...
    public IValueObject execute(IValueObject vo) {
        ...
        AvancRembLiquid avancRembLiquidNew = (AvancRembLiquid)placementService.rejeterLiquidationAnticipePlacement(paramContratPlacement);
