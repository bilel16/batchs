...
public class GetListContratMandataireCmd implements ICommande{
    public GetListContratMandataireCmd() {
    }
    ...
    public IValueObject execute(IValueObject vo) {
        ...
        Listes listeContrat = 
            (Listes)personneService.getListContratMandataire(personneStrc);
        return (listeContrat);
    }
