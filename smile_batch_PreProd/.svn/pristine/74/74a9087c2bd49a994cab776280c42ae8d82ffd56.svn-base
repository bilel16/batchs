...
public class UpdateAssureurTrt extends Traitement{
   
    public UpdateAssureurTrt() {
    }
    public IValueObject perform(IValueObject vo) {
       ...
       try{
            ...
            crudService.update(assureur);
        
        } catch (Exception e) {
            com.oxia.fwk.core.Error erreur = new com.oxia.fwk.core.Error();
            StringBuffer text = 
                new StringBuffer("Erreur dans UpdateAssureurTrt : ");
            text.append(e.toString());
            erreur.setCode("100");
            erreur.setDescription(text.toString());
            erreur.setKey("UpdateAssureurTrt");
