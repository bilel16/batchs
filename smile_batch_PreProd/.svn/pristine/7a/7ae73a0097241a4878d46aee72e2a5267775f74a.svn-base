...
import com.bna.smile.model.banqueAssurance.traitement.ResiliationAutoRenouvellementAutoTrt;
...
public class MoulinetteRenouvResilAssuranceVie extends AbstractJob {

    private static final Logger logger = 
        Logger.getLogger(MoulinetteRenouvResilAssuranceVie.class);
    ...
    public void perform() {
        ...
        try {
            ...
            ResiliationAutoRenouvellementAutoTrt resiliationAutoRenouvellementAutoTrt = new ResiliationAutoRenouvellementAutoTrt();
            vo =resiliationAutoRenouvellementAutoTrt.exec(vo);
        } catch (Exception e) {
            logger.fatal("**** Exception *** MoulinetteRenouvResilAssuranceVie *** : " + this.getClass());
        }
    }
