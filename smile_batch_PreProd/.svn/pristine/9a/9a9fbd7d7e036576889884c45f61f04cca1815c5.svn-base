...
import com.bna.smile.batch.moulinette.MoulinetteMAJAutSmile;
import com.oxia.fwk.context.Context;
import com.oxia.fwk.context.ContextFactory;

public class MoulinetteMAJAutSmileTest {
    ...
    public static void main(String[] args) {
        ...
        MoulinetteMAJAutSmile moulinette = new MoulinetteMAJAutSmile();
        moulinette.perform();
    }
}
