...
public class RenouvellementAssuranceVoyageFrame extends JFrame implements Serializable {
	...
	public RenouvellementAssuranceVoyageFrame frame_Instance = null;
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					...
					RenouvellementAssuranceVoyageFrame frame = new RenouvellementAssuranceVoyageFrame();
	 ...
	 * Create the frame.
	 */
	public RenouvellementAssuranceVoyageFrame() {

		setTitle("Batch Renouvellement Assurance Voyage ");
		...
		btnExcuter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (radio_Virement.isSelected()) {
					...
					new Thread(new MoulinetteRenouvAssuranceVoyageTest(frame_Instance)).start();
		...
		radio_Virement = new JRadioButton("Renouvellement Assurance Voyage");
		radio_Virement.setSelected(true);
		buttonGroup.add(radio_Virement);
		radio_Virement.setBounds(35, 94, 300, 23);
