...
public class GetListMembreCotitulaireCmd implements ICommande{
    public GetListMembreCotitulaireCmd() {
    }
    ...
    public IValueObject execute(IValueObject vo) {
        ...
        Listes listeCotit = 
            (Listes)personneService.getListMembreCotitulaire(personneStrc);
        return (listeCotit);
    }
