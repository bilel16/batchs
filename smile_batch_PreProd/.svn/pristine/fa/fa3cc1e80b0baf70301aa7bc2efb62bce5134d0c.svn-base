...
public class ValiderLiquidationAnticipeePlacementCmd implements ICommande{
    public ValiderLiquidationAnticipeePlacementCmd() {
    }
    ...
    public IValueObject execute(IValueObject vo) {
        ...
        AvancRembLiquid avancRembLiquidNew = (AvancRembLiquid)placementService.validerLiquidationAnticipeePlacement(avancRembLiquid);
