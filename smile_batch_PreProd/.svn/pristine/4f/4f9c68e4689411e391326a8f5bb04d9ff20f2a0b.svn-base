...
public class SegmentForm extends ActionForm {
    ...
    private String libSClas = "";
    private String codSClas = "";
    ...
    public void setLibSClas(String libSClas) {
        this.libSClas = libSClas;
    }

    public String getLibSClas() {
        return libSClas;
    }

    public void setCodSClas(String codSClas) {
        this.codSClas = codSClas;
    }

    public String getCodSClas() {
        return codSClas;
    }
