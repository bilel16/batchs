...
import com.bna.smile.batch.moulinette.MoulinetteAssuranceVie;
import com.oxia.fwk.context.Context;
import com.oxia.fwk.context.ContextFactory;

public class PrevelementAssuranceVie {
    public PrevelementAssuranceVie() {
    }
    ...
    public static void main(String[] args) {
        ...
        MoulinetteAssuranceVie moulinette = new MoulinetteAssuranceVie();
        moulinette.perform();
    }
}
