...
public class InsertInteretServiTrt extends Traitement{
    public InsertInteretServiTrt() {
    }
    public IValueObject perform (IValueObject vo ){
        ///----------- création interets servis  ----------------------                    
      InteretServi interetServi  = (InteretServi )vo;         
       try{ 
            ...
            if(!interetServi.equals(null)){
               crudService.create(interetServi);    
            } 
          }catch (Exception e) {
                com.oxia.fwk.core.Error erreur=new com.oxia.fwk.core.Error();
                erreur.setCode("Technique");
                erreur.setDescription("contratPlacementTrt  "+e.getMessage());;
                interetServi.addError(erreur);
