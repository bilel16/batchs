...
public class InsertExonerationTvaTrt extends Traitement{
   

    public InsertExonerationTvaTrt() {
    }
    ...
    public IValueObject perform(IValueObject vo) {
       ...
       try{
            ...
            crudService.create(exonerationCltTva);

        } catch (Exception e) {
            com.oxia.fwk.core.Error erreur = new com.oxia.fwk.core.Error();
            StringBuffer text = 
                new StringBuffer("Erreur dans InsertExonerationTvaTrt : ");
