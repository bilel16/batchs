...
public class BatchCommissionSouscriptionPackFrame extends JFrame implements Serializable {
	...
	public BatchCommissionSouscriptionPackFrame frame_Instance = null;
	private JRadioButton radio_Pack;
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					...
					BatchCommissionSouscriptionPackFrame frame = new BatchCommissionSouscriptionPackFrame();
	 ...
	 * Create the frame.
	 */
	public BatchCommissionSouscriptionPackFrame() {

		setTitle("Batch Commission Frais Tenue Compte Pack");
		...
		btnExcuter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (radio_Pack.isSelected()) {
					btnExcuter.setEnabled(false);
					end_exec_label.setText("");
					new Thread(new MoulinetteCommissionTenueComptePackTest(frame_Instance)).start();
		...
		radio_Pack = new JRadioButton("Frais Tenue Compte Pack");
		radio_Pack.setSelected(true);
		buttonGroup.add(radio_Pack);
		radio_Pack.setBounds(35, 94, 250, 23);
		panel.add(radio_Pack);
	...
	public JRadioButton getRadio_Pack() {
		return radio_Pack;
	}

	public void setRadio_Pack(JRadioButton radio_Pack) {
		this.radio_Pack = radio_Pack;
	}
}
