...
public class GetListMouvementCaisseCmd implements ICommande{
    public GetListMouvementCaisseCmd() {
    }
    public IValueObject execute(IValueObject vo) {
        ...
        Listes listesMvtCaisse = (Listes)caisseService.getListMvtCaisse(paramMvtCaisse);
