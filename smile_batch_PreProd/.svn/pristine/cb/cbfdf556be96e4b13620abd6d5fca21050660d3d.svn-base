...
public class UpdateContratPlacementCmd implements ICommande{
    public UpdateContratPlacementCmd() {
    }
    public IValueObject execute(IValueObject vo) {
        ...
        ContratPlacement contratPlacementNew = (ContratPlacement)placementService.updateContratPlacement(contratPlacement);
