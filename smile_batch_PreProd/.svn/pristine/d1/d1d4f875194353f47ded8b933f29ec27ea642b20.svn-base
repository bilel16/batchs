...
public class Cro963ReceptionRejetTrt extends Traitement {
	...
	public Cro963ReceptionRejetTrt() {
	}
	...
	public IValueObject perform(IValueObject vo) {
		...
		try {
			...
			StringBuffer text = new StringBuffer("Erreur dans Cro963ReceptionRejetTrt : ");
			text.append(e.toString());
			erreur.setCode("100");
			erreur.setDescription(text.toString());
			erreur.setKey("Cro963ReceptionRejetTrt");
			receptionEffetVo.addError(erreur);
			logger.error("Erreur au niveau Cro963ReceptionRejetTrt : ", e);
	...
	public void genCroText(ValueObject vo) {
		...
		try {
			...
			operation.setCodOperOper(Constants.COD_OPER_RECEP_REJET_ENC_LCR);
			...
			this.setLibRefCro("Réception Rejet Effet ENC LCR");
