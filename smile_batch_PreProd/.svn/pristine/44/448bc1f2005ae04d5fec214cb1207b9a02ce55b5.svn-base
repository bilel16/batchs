...
public class DeleteAbonnementTrt extends Traitement{
    public DeleteAbonnementTrt() {
    }
      ...
      AbonnementPlacement abonnementPlacement  = (AbonnementPlacement )vo;         
       try{ 
            ...
            if(!abonnementPlacement.equals(null)){
               crudService.remove(abonnementPlacement);    
            } 
          }catch (Exception e) {
                com.oxia.fwk.core.Error erreur=new com.oxia.fwk.core.Error();
                erreur.setCode("Technique");
                erreur.setDescription("DeleteAbonnementTrt  "+e.getMessage());;
