 ...
 * 
 */
public class PrevaliderCertificationChequeDeplaceeTrt extends Traitement {
    public PrevaliderCertificationChequeDeplaceeTrt() {
    }
    ...
    public IValueObject perform(IValueObject vo) throws Exception {
        ...
        try {
            ...
            ContratCptId contratCptIdRech = new ContratCptId();
            contratCptIdRech.setCodStrcStrc(paramDemandeChequeCertifie.getCertificationCheques().getContratCpt().getContratCptId().getCodStrcStrc());
            contratCptIdRech.setCodPrdPrd(paramDemandeChequeCertifie.getCertificationCheques().getContratCpt().getContratCptId().getCodPrdPrd());
            contratCptIdRech.setNumCcptCcpt(paramDemandeChequeCertifie.getCertificationCheques().getContratCpt().getContratCptId().getNumCcptCcpt());
            contratCptRech = 
                    (ContratCpt)getDetailContratTrt.exec(contratCptIdRech);
    ...
    public void genCroText(ValueObject vo) {
        ...
        cro.append(paramDemandeChequeCertifie.getOperationMoyPay().getStructureReceptrice().getCodStrcStrc().toString() + 
                   ";");
