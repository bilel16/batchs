...
public class DelivranceChequiersTrt extends Traitement {
    

    public DelivranceChequiersTrt() {
    }

    /**
     * Methode permettant la délivrance des chequiers
    ...
    public IValueObject perform(IValueObject vo) {
        ...
        /* MAJ de la demande cheque et mise à jour des chequiers et insertion des detail opérations
        ...
        try {
         if(this.checkClotureJournee()){
            ...
            if (demandeCheque.getChequiers() != null && 
                ...
                // mise à jour des chequiers dans la table chequiers
            ...
            com.oxia.fwk.core.Error erreur = new com.oxia.fwk.core.Error();
            StringBuffer text = 
                new StringBuffer("Erreur dans DelivranceChequiersTrt : ");
            text.append(e.toString());
            erreur.setCode("100");
            erreur.setDescription(text.toString());
            erreur.setKey("DelivranceChequiers");
            demandeCheque.addError(erreur);
