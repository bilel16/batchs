 ...
 * 
 */
public class PecDrDqmrpTrt extends Traitement{
    public PecDrDqmrpTrt() {
    }
    ...
    public IValueObject perform(IValueObject vo) throws Exception{
        ...
        try {
            ...
            //DetailOperDemCart detailOperDemCart = (DetailOperDemCart) insertDetailOperDemCartTrt.execute(demandeCarte);
             ValueObject voRetour = (ValueObject)insertDetailOperDemCartTrt.perform(demandeCarte);
             if (voRetour == null || voRetour.hasError()) {
                ...
                erreur.setDescription("PecDrDqmrpTrt "+e.getMessage());;
                demandeCarte.addError(erreur);
