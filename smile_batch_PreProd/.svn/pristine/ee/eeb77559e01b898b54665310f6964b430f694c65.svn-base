...
public class VirementAEcheanceBacthLauncher implements Serializable {

	private static final long serialVersionUID = 1L;

	public static void main(String[] args) {
		try {
			MoulinetteVirementsAecheanceControlMTest moulinette = new MoulinetteVirementsAecheanceControlMTest();
