...
public class UpdateMontantMADCmd {
    public UpdateMontantMADCmd() {
    }
    /**
     * methode execute
    ...
    public ValueObject execute(ValueObject vo) {
        ...
        montantMiseDiposition = (MontantMiseDiposition)guichetService.UpdateMontantMAD(montantMiseDiposition);
