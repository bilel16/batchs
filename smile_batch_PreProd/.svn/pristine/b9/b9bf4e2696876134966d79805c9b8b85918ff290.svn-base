...
public class Cro827RejetEffetAutoTrt extends Traitement {

	SimpleDateFormat formaterDate = new SimpleDateFormat("dd/MM/yyyy");
	SimpleDateFormat formaterHeure = new SimpleDateFormat("HH:mm:ss");

	public Cro827RejetEffetAutoTrt() {
	}
	...
	public IValueObject perform(IValueObject vo) {
		...
		try {
			...
			StringBuffer text = new StringBuffer("Erreur dans Cro827RejetEffetAutoTrt : ");
			text.append(e.toString());
			erreur.setCode("100");
			erreur.setDescription(text.toString());
			erreur.setKey("Cro827RejetEffetAutoTrt");
			reglementEffetVo.addError(erreur);
			logger.error("Erreur au niveau Cro827RejetEffetAutoTrt  : ", e);
	...
	public void genCroText(ValueObject vo) {
		try {
			...
			operation.setCodOperOper(Constants.COD_OPERATION_REJET_EFFET);
			...
			this.setLibRefCro("REJET AUTO EFFET");
