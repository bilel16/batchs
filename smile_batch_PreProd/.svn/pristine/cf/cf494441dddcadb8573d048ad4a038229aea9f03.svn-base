 ...
 *  @version 1.0
 *  */
public class GetPersonneByPieceAnnexeCmd implements ICommande {
    public GetPersonneByPieceAnnexeCmd() {
    }

    /** methode execute
     * @param  Objet PersonneStrc  :Identifiant par pièce annexe de la personne;
     * @return Objet PieceAnnxe
     **/
    public IValueObject execute(IValueObject vo) {
        ...
        Personne personne = 
            (Personne)personneService.getPieceAnnexe(personneStrc);
        return (personne);
