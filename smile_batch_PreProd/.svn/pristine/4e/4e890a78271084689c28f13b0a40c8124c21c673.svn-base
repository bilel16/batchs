...
public class GetSituationMensuelleInteretByCategPersTrt extends Traitement{
    public GetSituationMensuelleInteretByCategPersTrt() {
    }
    ...
    List situationMensuelleDao = plcDao.getSituationMensuelleIntCategClt(codeCategorie,dateComptable,codeStructre);
                ...
                if (sitMens.getValue(0) != null) {
                    recap.setCodStrcStrc(Long.valueOf(sitMens.getValue(0).toString()));
                     ...
                     if (sitMens.getValue(1)!= null) {
                          recap.setMntIrcServi(StrHandler.formatmnt(Long.valueOf(sitMens.getValue(1).toString()).doubleValue()));
                      }
                      if (sitMens.getValue(2) != null) {
                          recap.setMntIntertServiBrut(StrHandler.formatmnt(Long.valueOf(sitMens.getValue(2).toString()).doubleValue()));
                      }
                    
                    if (sitMens.getValue(3) != null) {
                      recap.setMntIntertServi(StrHandler.formatmnt(Long.valueOf(sitMens.getValue(3).toString()).doubleValue()));
                    }
                if (sitMens.getValue(4) != null) {
                    recap.setLibProduit(sitMens.getValue(4).toString());
                }
               if (sitMens.getValue(5) != null) {
                    recap.setLibCategorie(sitMens.getValue(5).toString());
                }
