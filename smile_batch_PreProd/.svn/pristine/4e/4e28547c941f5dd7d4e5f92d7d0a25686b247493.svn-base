...
public class GetListAbonnementsTrt extends Traitement{
    public GetListAbonnementsTrt() {
    }
  ...
  */
    ...
    try{        
        ...
        if (paramAbonnementement.getNumSeqCpla()!=null)      
            critereCptPlacement.add(expression.eq("contratPlacement.numSeqCpla",paramAbonnementement.getNumSeqCpla()));
        
        if (paramAbonnementement.getNumSeqArl()!=null)      
                critereCptPlacement.add(expression.eq("avancRembLiquid.numSeqArl",paramAbonnementement.getNumSeqArl()));
