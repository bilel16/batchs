...
public class BatchVirementFrame extends JFrame implements Serializable {
	...
	public BatchVirementFrame frame_Instance = null;
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					...
					BatchVirementFrame frame = new BatchVirementFrame();
	 ...
	 * Create the frame.
	 */
	public BatchVirementFrame() {

		setTitle("Batch Virements à Échéances");
		...
		btnExcuter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (radio_Virement.isSelected()) {
					...
					new Thread(new MoulinetteVirementsAecheanceTest(frame_Instance)).start();
		...
		radio_Virement = new JRadioButton("Virement");
