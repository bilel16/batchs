...
public class InsertOpMoyPayActelRecuTrt extends Traitement {

	public Context context = ContextHandler.getContext();
	OperationMoyPay operationMoyPay;
	public InsertOpMoyPayActelRecuTrt() {
	}
	...
	public IValueObject perform(IValueObject vo) {
		...
		try {
			...
			StringBuffer text = new StringBuffer("Erreur dans MAJ NSI InsertOpMoyPayActelRecuTrt : ");
		...
		public void genCroText(ValueObject vo) {
			...
			this.setLibRefCro("smile.batch.ACTEL.TransfertRecu");
