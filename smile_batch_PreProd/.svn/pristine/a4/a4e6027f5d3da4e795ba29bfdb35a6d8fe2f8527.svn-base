...
import com.bna.smile.batch.test.BatchRenouvellementAssuranceVieDecouvertAMIFrame;
...
public class MoulinetteRenouvellementAssuranceVieDecouvertAMI extends AbstractJob {

	private static final Logger logger = Logger.getLogger(MoulinetteRenouvellementAssuranceVieDecouvertAMI.class);
	private BatchRenouvellementAssuranceVieDecouvertAMIFrame mainFrame;
	 ...
	 * Consutructor
	 */
	public MoulinetteRenouvellementAssuranceVieDecouvertAMI() {
		super();
	}

	public MoulinetteRenouvellementAssuranceVieDecouvertAMI(ParamAdhesion paramAdhesion) {
		super();
		this.paramAdhesion = paramAdhesion;
	}

	public MoulinetteRenouvellementAssuranceVieDecouvertAMI(ParamAdhesion paramAdhesion,
			BatchRenouvellementAssuranceVieDecouvertAMIFrame mainFrame) {
		super();
		this.paramAdhesion = paramAdhesion;
	...
	public void setMainFrame(BatchRenouvellementAssuranceVieDecouvertAMIFrame mainFrame) {
		this.mainFrame = mainFrame;
	}

	public BatchRenouvellementAssuranceVieDecouvertAMIFrame getMainFrame() {
		return mainFrame;
	}
