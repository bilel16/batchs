...
import com.bna.smile.model.banqueAssurance.traitement.PrelevementAssuranceVieTrt;
...
public class MoulinetteAssuranceVie extends AbstractJob {

    private static final Logger logger = 
        Logger.getLogger(MoulinetteAssuranceVie.class);
    ...
    public void perform() {
        ...
        try {
            ...
            PrelevementAssuranceVieTrt prelevementAssuranceVieTrt = new PrelevementAssuranceVieTrt();
            vo =prelevementAssuranceVieTrt.exec(vo);
        } catch (Exception e) {
            logger.fatal("**** Exception *** PrelevementAssuranceVieTrt *** : " + this.getClass());
        }
    }
