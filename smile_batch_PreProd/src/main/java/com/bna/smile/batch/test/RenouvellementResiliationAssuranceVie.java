...
import com.bna.smile.batch.moulinette.MoulinetteRenouvResilAssuranceVie;
import com.oxia.fwk.context.Context;
import com.oxia.fwk.context.ContextFactory;

public class RenouvellementResiliationAssuranceVie{
    public RenouvellementResiliationAssuranceVie() {
    }
    ...
    public static void main(String[] args) {
        ...
        MoulinetteRenouvResilAssuranceVie moulinette = new MoulinetteRenouvResilAssuranceVie();
        moulinette.perform();
    }
}
