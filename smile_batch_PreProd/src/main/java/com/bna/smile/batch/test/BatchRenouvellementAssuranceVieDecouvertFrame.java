...
public class BatchRenouvellementAssuranceVieDecouvertFrame extends JFrame implements Serializable {
	...
	public BatchRenouvellementAssuranceVieDecouvertFrame frame_Instance = null;
	private JRadioButton radio_AssuranceVie;
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					...
					BatchRenouvellementAssuranceVieDecouvertFrame frame = new BatchRenouvellementAssuranceVieDecouvertFrame();
	 ...
	 * Create the frame.
	 */
	public BatchRenouvellementAssuranceVieDecouvertFrame() {

		setTitle("Batch Renouvellement Assurance Vie Sur Découvert");
		...
		btnExcuter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (radio_AssuranceVie.isSelected()) {
					btnExcuter.setEnabled(false);
					end_exec_label.setText("");
					new Thread(new MoulinetteRenouvellementAssuranceVieDecouvertTest(frame_Instance)).start();
		...
		radio_AssuranceVie = new JRadioButton("Renouvellement Assurance Vie Sur Découvert");
		radio_AssuranceVie.setSelected(true);
		buttonGroup.add(radio_AssuranceVie);
		radio_AssuranceVie.setBounds(35, 94, 300, 23);
		panel.add(radio_AssuranceVie);
