...
public class BatchMAJNSIActelFrame extends JFrame implements Serializable {
	...
	public BatchMAJNSIActelFrame frame_Instance = null;
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					...
					BatchMAJNSIActelFrame frame = new BatchMAJNSIActelFrame();
	 ...
	 * Create the frame.
	 */
	public BatchMAJNSIActelFrame() {

		setTitle("Batch Actel  : MAJ NSI ");
		...
		btnExcuter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (radio_Virement.isSelected()) {
					...
					new Thread(new MoulinetteMAJNSIActelTest(frame_Instance)).start();
		...
		radio_Virement = new JRadioButton("MAJ NSI Actel");
