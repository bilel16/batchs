...
import com.bna.smile.model.domaineplacement.traitement.IntretServiTrt;
...
public class MoulInteretServiPlac extends AbstractJob {
    ...
    public void perform() {
        ...
        try {
            ...
            IntretServiTrt intretServiTrt = new IntretServiTrt();
            vo =intretServiTrt.exec(vo);
        } catch (Exception e) {
