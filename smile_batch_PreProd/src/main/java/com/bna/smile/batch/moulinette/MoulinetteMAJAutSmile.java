...
import com.bna.smile.model.domaineguichet.traitement.MAJAutSmileTrt;
...
public class MoulinetteMAJAutSmile extends AbstractJob {

    private static final Logger logger = 
        Logger.getLogger(MoulinetteMAJAutSmile.class);
...
//            guichetService.MAJNSI(new ValueObject());
            MAJAutSmileTrt majsoldes= new MAJAutSmileTrt();
            majsoldes.exec(new ValueObject());
        } catch (Exception e) {
