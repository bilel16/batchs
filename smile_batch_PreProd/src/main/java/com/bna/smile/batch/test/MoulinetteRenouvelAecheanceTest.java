...
import com.bna.smile.batch.moulinette.MoulinetteRenouvelAecheance;
import com.oxia.fwk.context.Context;
import com.oxia.fwk.context.ContextFactory;

public class MoulinetteRenouvelAecheanceTest implements Runnable {
    public MoulinetteRenouvelAecheanceTest() {
    }
    @Override
	public void run() {
        ...
        MoulinetteRenouvelAecheance moulinette = new MoulinetteRenouvelAecheance();
        moulinette.perform();
        System.out.println("Moulinette Renouvellement A Echeance terminée avec succès");
    }
