...
import com.bna.smile.batch.moulinette.MoulinetteLiquidationAecheance;
import com.oxia.fwk.context.Context;
import com.oxia.fwk.context.ContextFactory;

public class MoulinetteLiquidationAecheanceTest implements Runnable {
	...
	public void run() {
		...
		MoulinetteLiquidationAecheance moulinette = new MoulinetteLiquidationAecheance();
		moulinette.perform();
	}
