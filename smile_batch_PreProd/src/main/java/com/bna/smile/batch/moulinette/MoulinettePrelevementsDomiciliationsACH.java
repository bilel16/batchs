...
import com.bna.smile.model.prelevement.traitement.InsertionPrelevementsDomiciliationsACHTrt;
 ...
 **/
public class MoulinettePrelevementsDomiciliationsACH extends AbstractJob {

	private static final Logger logger = Logger.getLogger(MoulinettePrelevementsDomiciliationsACH.class);
	 ...
	 * Consutructor
	 */
	public MoulinettePrelevementsDomiciliationsACH() {
		super();

	}

	public MoulinettePrelevementsDomiciliationsACH(PrelevementVo prelevementVo) {
		super();
		this.prelevementVo = prelevementVo;
	}

	public MoulinettePrelevementsDomiciliationsACH(PrelevementVo prelevementVo, BatchFrame mainFrame) {
		super();
		this.prelevementVo = prelevementVo;
	...
	public void perform() {
		...
		try {
			...
			InsertionPrelevementsDomiciliationsACHTrt insertionPrelevementsDomiciliationsACHTrt = new InsertionPrelevementsDomiciliationsACHTrt();
			prelevementVo = (PrelevementVo) insertionPrelevementsDomiciliationsACHTrt.exec(prelevementVo);

			logger.info("Moulinette InsertionPrelevementsDomiciliations ACH a été générée avec sucées");
			// //////////////
		} catch (Exception e) {
