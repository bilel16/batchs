...
public class MoulinetteVirementsAecheance extends AbstractJob {

	private static final Logger logger = Logger.getLogger(MoulinetteVirementsAecheance.class);
	private BatchVirementFrame mainFrame;
	 ...
	 * Consutructor
	 */
	public MoulinetteVirementsAecheance() {
		super();
	}

	public MoulinetteVirementsAecheance(VirementVo virementVo) {
		super();
		this.virementVo = virementVo;
	}

	public MoulinetteVirementsAecheance(VirementVo virementVo, BatchVirementFrame mainFrame) {
		super();
		this.virementVo = virementVo;
	...
	public void setMainFrame(BatchVirementFrame mainFrame) {
		this.mainFrame = mainFrame;
	}

	public BatchVirementFrame getMainFrame() {
		return mainFrame;
	}
