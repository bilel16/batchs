...
public class ActiviteForm extends ActionForm {
    ...
    private String libSClasAct = "";
    private String codSClasAct = "";
    ...
    public void setLibSClasAct(String libSClasAct) {
        this.libSClasAct = libSClasAct;
    }

    public String getLibSClasAct() {
        return libSClasAct;
    }

    public void setCodSClasAct(String codSClasAct) {
        this.codSClasAct = codSClasAct;
    }

    public String getCodSClasAct() {
        return codSClasAct;
    }
