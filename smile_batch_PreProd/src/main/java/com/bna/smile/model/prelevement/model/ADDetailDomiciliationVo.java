...
public class ADDetailDomiciliationVo extends ValueObject {
	...
	public Long getNumDom() {
		return numDom;
	}

	public void setNumDom(Long numDom) {
		this.numDom = numDom;
	}

	public Long getCodPay() {
		return codPay;
	}

	public void setCodPay(Long codPay) {
		this.codPay = codPay;
	}

	public String getCodMaj() {
		return codMaj;
	}

	public void setCodMaj(String codMaj) {
		this.codMaj = codMaj;
	}
