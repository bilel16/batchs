...
public class Cro949ReceptionRejetTrt extends Traitement {
	...
	public Cro949ReceptionRejetTrt() {
	}

	public IValueObject perform(IValueObject vo) {
		logger.info("Cro d'operation recepetion rejet Effet");
		...
		try {
			...
			StringBuffer text = new StringBuffer("Erreur dans Cro949ReceptionRejetTrt : ");
			text.append(e.toString());
			erreur.setCode("100");
			erreur.setDescription(text.toString());
			erreur.setKey("Cro949ReceptionRejetTrt");
			receptionEffetVo.addError(erreur);
			logger.error("Erreur au niveau Cro949ReceptionRejetTrt : ", e);
	...
	public void genCroText(ValueObject vo) {
		...
		try {
			...
			operation.setCodOperOper(Constants.COD_OPER_RECEP_REJET_EFFET);
			...
			String refIntSg = Constants.COD_DIR_TRESORERIE + "" + quantieme + "8RE";
			System.out.println(refIntSg);
			this.setCodRefInter(refIntSg);
			this.setNumRefCro(99999L);
			this.setLibRefCro("Réception Rejet Effet LCN");
