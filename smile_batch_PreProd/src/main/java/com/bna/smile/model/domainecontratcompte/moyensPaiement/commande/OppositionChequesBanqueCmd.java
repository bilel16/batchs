...
import com.oxia.fwk.core.ValueObject;
  ...
  * 
  */
public class OppositionChequesBanqueCmd  implements ICommande{
    public OppositionChequesBanqueCmd() {
    }
    ...
    public IValueObject execute(IValueObject vo) {
        ...
        return (ValueObject)oppositionMoyPaiService.oppositionChequesBanque(vo);
    }
}
