 ...
 * 
 */
public class AnnulRenouvCarteBancaireTrt  extends Traitement{
    public AnnulRenouvCarteBancaireTrt() {
    }
    ...
    public IValueObject perform(IValueObject vo) throws Exception{
        ...
        try {
            ...
            //DetailOperCarte detailOperCarte = (DetailOperCarte) insertDetailOperCarteTrt.exec(carteBancaire);
    ...
    public void genererSynchronisationPascal(ValueObject vo) {
        ...
        //partie fixe toujour envoi 33 et 3 pour syncro 
