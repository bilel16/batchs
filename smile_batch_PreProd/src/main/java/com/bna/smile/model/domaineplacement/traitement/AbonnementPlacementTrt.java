...
public class AbonnementPlacementTrt  extends Traitement{
    public AbonnementPlacementTrt() {
    }
    ...
    public IValueObject perform(IValueObject vo) {
        ...
        List listAgencesPlacement = plcDao.getListAgencesPlacementAb();
            ...
            if(listAgencesPlacement!=null && listAgencesPlacement.size()>0) {
                for (Iterator it1 = listAgencesPlacement.iterator(); it1.hasNext(); ){
                    ...
                    // tester si la journée batch n'est pas dejà inserée
                     ...
                     journeeStructureBatchId.setCodBatBmet(Constants.COD_BATCH_ABONNEMENT_PLAC);
                 ...
                 //   if( journeeStructureBatchRetour != null && journeeStructureBatchRetour.getCodStatJsb().intValue() == 0){ // structure non traitée
                         ...
                         paramInteretServi = (ParamInteretServi) placementService.abonnementPlacementAgence(paramInteretServi);
                             // journée batch OK
        ...
        return null;
            ...
            StringBuffer text = new StringBuffer("Erreur dans AbonnementPlacementTrt : ");
            text.append(e.toString());
            erreur.setCode("100");
            erreur.setDescription(text.toString());
            erreur.setKey("AbonnementPlacementTrt");
    ...
    public void genCroText(ValueObject vo) {
          ...
          this.setLibRefCro("SMILE.Placement.BatchAbonnement");
        ...
        cro.append(Constants.COD_OPER_ABONNE_INTERET_PLAC_POSTCOMPTE.toString()+";");
         
        this.setCroText(cro.toString());
        logger.error("\n  /*********************************************************/   \n"+
        "  /*************** Fin du Batch Abonnement *****************/   \n"+
        "  /*********************************************************/   \n");
