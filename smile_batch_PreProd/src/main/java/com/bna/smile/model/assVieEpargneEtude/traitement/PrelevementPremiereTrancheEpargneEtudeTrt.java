...
public class PrelevementPremiereTrancheEpargneEtudeTrt extends Traitement {

	Log logger = new Log(PrelevementPremiereTrancheEpargneEtudeTrt.class);
...
//				// 03. setting structure receptrice
				...
				operationMoyPayCredit.setMontDinOmp(contratFaiezVo.getCategorie().getMontTranch1Cat());

				operationMoyPayCredit.setMontApreOmp(contratCptBen.getMontSoldCcpt() + contratFaiezVo.getCategorie().getMontTranch1Cat());
				...
				// Checking Devise
				contratCptSold.setSolde(contratFaiezVo.getCategorie().getMontTranch1Cat());
...
//				operationMoyPayDebit.setStructureReceptrice(structureRecepD);
				...
				// 05. setting devise et montant
				operationMoyPayDebit.setMontDinOmp(contratFaiezVo.getCategorie().getMontTranch1Cat());

				operationMoyPayDebit.setMontApreOmp(contratCptDeb.getMontSoldCcpt() - contratFaiezVo.getCategorie().getMontTranch1Cat());
				...
				contratCptSoldDebit.setSolde(contratFaiezVo.getCategorie().getMontTranch1Cat());
				...
				assVieEpargneDAO.InsertTraceTrancheFaiezPayé(contratFaiezVo, sysdate, 1);
			}
