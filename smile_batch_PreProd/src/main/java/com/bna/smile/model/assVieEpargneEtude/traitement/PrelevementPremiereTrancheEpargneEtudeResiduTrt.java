...
public class PrelevementPremiereTrancheEpargneEtudeResiduTrt extends Traitement {

	Log logger = new Log(PrelevementPremiereTrancheEpargneEtudeResiduTrt.class);
...
//				// 03. setting structure receptrice
				...
				operationMoyPayCredit.setMontDinOmp(contratFaiezVo.getMont_trch1_cat());

				operationMoyPayCredit.setMontApreOmp(contratCptBen.getMontSoldCcpt() + contratFaiezVo.getMont_trch1_cat());
				...
				// Checking Devise
				contratCptSold.setSolde(contratFaiezVo.getMont_trch1_cat());
...
//				operationMoyPayDebit.setStructureReceptrice(structureRecepD);
				...
				// 05. setting devise et montant
				operationMoyPayDebit.setMontDinOmp(contratFaiezVo.getMont_trch1_cat());

				operationMoyPayDebit.setMontApreOmp(contratCptDeb.getMontSoldCcpt() - contratFaiezVo.getMont_trch1_cat());
				...
				contratCptSoldDebit.setSolde(contratFaiezVo.getMont_trch1_cat());
				...
				assVieEpargneDAO.UpdateTraceTrancheFaiezRésiduePayée(contratFaiezVo, sysdate, 1);
			}
