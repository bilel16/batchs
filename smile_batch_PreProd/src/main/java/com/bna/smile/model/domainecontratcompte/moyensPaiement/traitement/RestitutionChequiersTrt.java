...
public class RestitutionChequiersTrt extends Traitement{
   

    public RestitutionChequiersTrt() {
    }

    /**
     * Methode permettant la restitution des chequiers
    ...
    public IValueObject perform(IValueObject vo) {
        ...
        try {
            ...
            if (demandeCheque.getChequiers() != null && 
                ...
                for (Iterator it = demandeCheque.getChequiers().iterator(); 
                    ...
                    if (chequier.getChequierId().getNumChqiChqi() != null) {
                        ...
                        if (chequier.getCodEtatChqi().equals(Constants.ETAT_CHQ_RESTITUE)) {
                            if (demandeChequeDAO.getDetailOperationChequier(chequier, 
                                                                            demandeCheque.getTache().getTacheId().getCodOperOper()).equals(new Long(0))) {
            ...
            StringBuffer text = 
                new StringBuffer("Erreur dans RestitutionChequiersTrt : ");
            text.append(e.toString());
            erreur.setCode("100");
            erreur.setDescription(text.toString());
            erreur.setKey("RestitutionChequiers");
