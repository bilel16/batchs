...
public class PecResiliationAssVieCmd implements ICommande{
        public PecResiliationAssVieCmd() {
        }
        /**
        * methode execute
        * @param  vo Objet : ParamAdhesion
        * @return vo Objet : ParamAdhesion
        * @author Jerbi lamia 30/09/2010
        */
        ...
        DetailAdhesion detailAdhesion = 
            (DetailAdhesion)assuranceVieService.pecResiliationAssVie(paramAdhesion);
