...
public class CreationCROExecutionVirementPermanentTrt extends Traitement {
	...
	public CreationCROExecutionVirementPermanentTrt() {
	}
	...
	public IValueObject perform(IValueObject vo) {
		...
		try {
			...
			tacheId.setCodTachTach(Constants.COD_TACH_EXECUTION_VIREMENT_PERMANENT);
			tacheId.setCodOperOper(Constants.COD_OPER_EXECUTION_VIREMENT_PERMANENT);
			...
			operationMoyPayCompteDO.setLibObjOpOmp("EXECUTION VIREMENT PERMANENT " + motifEnvoi);
			...
			codstructureReceptrice = globalVirement.getStructure().getCodStrcStrc().toString();
			...
			Long montVirCcpt = detailVirement.getMntDetvDetv();
			...
			operationMoyPayCompteDO.setContratCpt(globalVirement.getContratCpt());
			...
			operationMoyPayCompteDO.setDetailVirement(detailVirement);
			...
			if (Constants.COD_OPER_EXECUTION_VIREMENT_PERMANENT.equals(operation.getCodOperOper())) {
			...
			operationMoyPayCompteDO.setMontTvaOmp((long) (montant_tva));
			...
			montant_commision = new Long(montant_commision);
			...
			traceVirement.setStructureEmettrice(structureInit);
			...
			StringBuffer text = new StringBuffer("Erreur dans CreationCROExecutionVirementPermanentTrt : ");
			text.append(e.toString());
			erreur.setCode("100");
			erreur.setDescription(text.toString());
			erreur.setKey("CreationCROExecutionVirementPermanentTrt");
			virementVo.addError(erreur);
			logger.error("Erreur au niveau CreationCROExecutionVirementPermanentTrt : ", e);
			virementVo.setMessageValidation("Probléme dans CreationCROExecutionVirementPermanentTrt");
	...
	public void genCroText(ValueObject vo) {
		logger.info("starting Creation CRO DO 720");
		...
		this.setLibRefCro("EXECUTION VIREMENT PERMANENT " + motifRefCro);
