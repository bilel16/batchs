...
public class GetListeContratsRejetesCmd implements ICommande {
    public GetListeContratsRejetesCmd() {
    }
    ...
    public IValueObject execute(IValueObject vo) {
       ...
       return (souscriptionContratCompteService.getListContratsRejetes(vo));
