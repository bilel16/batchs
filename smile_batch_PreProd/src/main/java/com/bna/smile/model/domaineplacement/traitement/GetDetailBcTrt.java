...
public class GetDetailBcTrt extends Traitement{
    public GetDetailBcTrt() {
    }
  ...
  */
    public ValueObject perform(IValueObject vo ){
        ...
        DetailsBc detailsBcTrouve = (DetailsBc)vo;
    ...
    try{        
        ...
        if (detailsBc.getContratPlacement().getNumSeqCpla()!=null)      
            critereCptPlacement.add(expression.eq("contratPlacement.numSeqCpla",detailsBc.getContratPlacement().getNumSeqCpla()));
        
         if (detailsBc.getNumBcDbc()!=null)      
              critereCptPlacement.add(expression.eq("numBcDbc",detailsBc.getNumBcDbc()));
            

        List l = searchEngine.find(DetailsBc.class, critereCptPlacement);
        if(l!=null && l.size()>0)
            detailsBcTrouve =(DetailsBc)l.get(0);
                            ...
                            detailsBcTrouve.addError(erreur);
                            throw new RuntimeException(e);
                           
            }
       return(detailsBcTrouve);
    }
