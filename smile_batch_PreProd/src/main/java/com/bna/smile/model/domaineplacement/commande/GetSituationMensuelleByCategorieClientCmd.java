...
public class GetSituationMensuelleByCategorieClientCmd implements ICommande{
    public GetSituationMensuelleByCategorieClientCmd() {
    }
    /**
         * methode execute 
        ...
        public IValueObject execute(IValueObject vo) {
            ...
            Listes situationMensuelle =(Listes)placementService.getSituationMensuelleCategorieClient(paramDemandeDecision);
