...
/** Fichier: DelivranceChequiersCmd.java
  * @version 1.0.0 du 26/06/2007
  * Copyright(c) 2007 BNA (www.bna.com.tn)
  * Classe: DelivranceChequiersCmd
  * package: com.bna.smile.model.domainecontratcompte.moyensPaiement.commande;
  * @author : El Arbi Hassine
  * Commande de délivrance des chequiers
  */
public class DelivranceChequiersCmd implements ICommande {
    Context context = ContextHandler.getContext();

    public DelivranceChequiersCmd() {
    }
    ...
    public IValueObject execute(IValueObject vo) {
        ...
        ValueObject voo = (ValueObject)demandeChequesService.delivranceChequiers(vo);
        return voo;
    }
}
