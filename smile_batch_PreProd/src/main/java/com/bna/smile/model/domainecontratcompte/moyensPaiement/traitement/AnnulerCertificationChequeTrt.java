 ...
 * 
 */
public class AnnulerCertificationChequeTrt extends Traitement {
    public AnnulerCertificationChequeTrt() {
    }
    ...
    public IValueObject perform(IValueObject vo) {
        ...
        try {
            ...
            //mise à jour de demande de certification ( mettre l'etat annulé);            
            crudService.update(paramDemandeChequeCertifie.getCertificationCheques());

            if (paramDemandeChequeCertifie.getCertificationCheques().getCodEtatCchq().equals(Constants.ETAT_CERT_ANNULEE)) {

                this.setCroFlag(true); // generer le cro...
                // si l'etat de l'operation_moy_pay est annulé alors on doit mettre à jour le solde du contrat:
            ...
            erreur.setDescription("AnnulerCertificationChequeTrt " + e.toString());            
