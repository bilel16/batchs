 ...
 * @version 1.0.0 du 30/04/2006
 * Copyright(c) 2007 BNA (www.bna.com.tn)
 * Classe: InsertClientContratCmd
 * package com.bna.smile.model.domainecontratcompte.souscriptioncontratcompte.commande
 * @author :  El arbi hassine && Mdimagh Lassad
 */
public class InsertCompteLieCmd implements ICommande {

    public InsertCompteLieCmd() {
    }

    /**
     * Methode execute
     * @param vo Objet :    PramCompteLie
    ...
    public IValueObject execute(IValueObject vo) {
        ...
        ValueObject voo = (ValueObject)souscriptionContratCompteService.insertCompteLie(vo);
        return (voo);
    }
