...
public class PrelevementTroisiemeTrancheEpargneEtudeTrt extends Traitement {

	Log logger = new Log(PrelevementTroisiemeTrancheEpargneEtudeTrt.class);
...
//				// 03. setting structure receptrice
				...
				operationMoyPayCredit.setMontDinOmp(contratFaiezVo.getCategorie().getMontTranch3Cat());

				operationMoyPayCredit.setMontApreOmp(contratCptBen.getMontSoldCcpt() + contratFaiezVo.getCategorie().getMontTranch3Cat());
				...
				// Checking Devise
				contratCptSold.setSolde(contratFaiezVo.getCategorie().getMontTranch3Cat());
...
//				operationMoyPayDebit.setStructureReceptrice(structureRecepD);
				...
				// 05. setting devise et montant
				operationMoyPayDebit.setMontDinOmp(contratFaiezVo.getCategorie().getMontTranch3Cat());

				operationMoyPayDebit.setMontApreOmp(contratCptDeb.getMontSoldCcpt() - contratFaiezVo.getCategorie().getMontTranch3Cat());
				...
				contratCptSoldDebit.setSolde(contratFaiezVo.getCategorie().getMontTranch3Cat());
				...
				assVieEpargneDAO.InsertTraceTrancheFaiezPayé(contratFaiezVo, sysdate, 3);
			}
