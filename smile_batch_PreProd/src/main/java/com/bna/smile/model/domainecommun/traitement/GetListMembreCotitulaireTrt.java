...
public class GetListMembreCotitulaireTrt extends Traitement{
    public GetListMembreCotitulaireTrt() {
    }
        ...
        try {
            ...
            IExpression expression = searchEngine.createExpression();
             ...
             if (pers.getNumSeqPers()!=null){
                 criteriaCotit.add(expression.eq("coTitulaireId.numSeqCli", 
                                                  pers.getNumSeqPers()));
                ...
                StringBuffer text = 
                    new StringBuffer("Erreur dans GetListMembreCotitulaireTrt : ");
                text.append(e.toString());
                erreur.setCode("100");
                erreur.setDescription(text.toString());
                erreur.setKey("GetListMembreCotitulaireTrt");
