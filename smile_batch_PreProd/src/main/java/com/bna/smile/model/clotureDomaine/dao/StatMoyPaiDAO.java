...
public class StatMoyPaiDAO {
    public StatMoyPaiDAO() {
    }
    ...
    public List getStatAdDetailVirement(Long codeStructure, Long codesens, Long codeEnrg,
                                   Date dateOperation) {
        jt = new JdbcTemplate(dataSource);
        String req1 = "select COD_BCT_STRC from structure where COD_STRC_STRC=" + codeStructure;
        Long codeBct = jt.queryForLong(req1);
        String requete = 
            new String("select count(*),SUM(MNT_VIR)  from ad_detail_virement where " + 
                       " to_char(DAT_OPE,'DD/MM/YYYY') = '" + 
                       DateHandler.dateToStr(dateOperation) + "'" + 
                       " AND COD_SEN=" + codesens +
                       " AND COD_ENR=" + codeEnrg +
                       " AND COD_AGE=" + codeBct);
    ...
    public List getAccuseByStructure (Long codeStructure,Date dateChargement){ 
        ...
        String req ="select cod_age,cod_val,lib_val_val, cod_enr, num_lot, sum(nbr_tot) nbr_tot, sum(mnt_tot) mnt_tot " +
        ...
        " and v.ref_lot is not null and v.cod_enr=11 " +
        " UNION " +
        ...
        " and vs.ref_lot is not null and vs.cod_enr=11 " +
        " union all " +
        ...
        " and ac30.ref_lot is not null and ac30.dat_ope='" + DateHandler.dateToStr(dateChargement) + "'" +
        ...
        " and ac31.ref_lot is not null  and ac31.dat_ope='" + DateHandler.dateToStr(dateChargement) + "'" +
       ...
       // " and ac31.ref_lot is not null " +
        ...
        " and ac32.ref_lot is not null and ac32.dat_ope='" + DateHandler.dateToStr(dateChargement) + "'" +
        ...
        " and ac33.ref_lot is not null and ac33.dat_ope='" + DateHandler.dateToStr(dateChargement) + "'" +
        ...
        " and acnp.ref_lot is not null and acnp.dat_ope='" + DateHandler.dateToStr(dateChargement) + "'" +
        ...
        " and arp.ref_lot is not null and arp.dat_ope='" + DateHandler.dateToStr(dateChargement) + "'" + 
        ...
        " and ap.ref_lot is not null and ap.dat_ope='" + DateHandler.dateToStr(dateChargement) + "'" + 
        ...
        " and apre.ref_lot is not null and apre.dat_ope='" + DateHandler.dateToStr(dateChargement) + "'" + 
  ...
  //  System.out.println(req);
        listAccuses = jt.query(req, new RowMapper() {
                        ...
                        public Object mapRow(ResultSet rs, 
                            ...
                            if(accuse.getCodeValeur()==30||accuse.getCodeValeur()==31
                              ||  accuse.getCodeValeur()==32 || accuse.getCodeValeur()==33){
                            ...
                            accuse.setMntPresentation(format.format(Double.parseDouble(rs.getString("MNT_TOT"))));
