 ...
 * 
 */
public class RestituerCertificationChequeTrt extends Traitement {
    public RestituerCertificationChequeTrt() {
    }
    ...
    public IValueObject perform(IValueObject vo) {
        ...
        try {
            ...
            //mise à jour de demande de certification ( mettre l'etat restitué);            
            crudService.update(paramDemandeChequeCertifie.getCertificationCheques());

            if (paramDemandeChequeCertifie.getCertificationCheques().getCodEtatCchq().equals(Constants.ETAT_CERT_RESTITUEE)) {

                this.setCroFlag(true); // generer le cro...
                // si l'etat de l'operation_moy_pay est restitué alors on doit mettre à jour le solde du contrat:
            ...
            erreur.setDescription("RestituerCertificationChequeTrt " + e.toString());           
