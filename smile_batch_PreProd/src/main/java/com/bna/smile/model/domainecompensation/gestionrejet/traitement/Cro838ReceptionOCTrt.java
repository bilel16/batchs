...
public class Cro838ReceptionOCTrt extends Traitement {
	...
	public Cro838ReceptionOCTrt() {
	}

	public IValueObject perform(IValueObject vo) {
		logger.info("Cro d'operation recepetion OC");
		...
		try {
			...
			StringBuffer text = new StringBuffer("Erreur dans Cro838ReceptionOCTrt : ");
			text.append(e.toString());
			erreur.setCode("100");
			erreur.setDescription(text.toString());
			erreur.setKey("Cro838ReceptionOCTrt");
			compensationEffetVo.addError(erreur);
			logger.error("Erreur au niveau Cro838ReceptionOCTrt : ", e);
	...
	public void genCroText(ValueObject vo) {
		try {
			...
			operation.setCodOperOper(Constants.COD_OPER_RECEP_COMP_OC);
			...
			String refIntSg =Constants.COD_DIR_TRESORERIE+ quantieme+ "2LC";
			this.setCodRefInter(refIntSg);
			this.setNumRefCro(Long.valueOf("9999"));
			this.setLibRefCro("Réception presentation Effet OC");
