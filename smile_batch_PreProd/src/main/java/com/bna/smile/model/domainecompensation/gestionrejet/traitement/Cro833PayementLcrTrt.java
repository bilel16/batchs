...
public class Cro833PayementLcrTrt extends Traitement {
	...
	public IValueObject perform(IValueObject vo) {
		...
		try {
			...
			traitementConditionBanque.setCodOperOper("" + Constants.COD_OPERATION_PAIEMENT_LCR);
			...
			operationMoyPay.setLibObjOpOmp("PAIEMENT LCR ");
			...
			oper.setCodOperOper(Constants.COD_OPERATION_PAIEMENT_LCR);
			Tache tache = new Tache();
			tache.setOperation(oper);
			TacheId tacheId = new TacheId();
			tacheId.setCodOperOper(Constants.COD_OPERATION_PAIEMENT_LCR);
			...
			operationMoyPay.setLibMotfOmp("PAIEMENT LCR");
			...
			StringBuffer text = new StringBuffer("Erreur dans Cro833PayementLcrTrt : ");
			text.append(e.toString());
			erreur.setCode("100");
			erreur.setDescription(text.toString());
			erreur.setKey("Cro833PayementLcrTrt");
			reglementEffetVo.addError(erreur);
			logger.error("Erreur au niveau Cro833PayementLcrTrt : ", e);
	...
	public void genCroText(ValueObject vo) {
		...
		operation.setCodOperOper(Constants.COD_OPERATION_PAIEMENT_LCR);
		...
		this.setLibRefCro("PAIEMENT LCR");
