...
public class ReceptionChequiersTrt  extends Traitement{
     

    public ReceptionChequiersTrt() {
    }

    /**
     * Methode permettant la réception des chequiers
    ...
    public IValueObject perform(IValueObject vo) {
        ...
        try {
          if(this.checkClotureJournee()){
            ...
            com.oxia.fwk.core.Error erreur = new com.oxia.fwk.core.Error();
            StringBuffer text = 
                new StringBuffer("Erreur dans ReceptionChequiersTrt : ");
            text.append(e.toString());
            erreur.setCode("100");
            erreur.setDescription(text.toString());
            erreur.setKey("ReceptionChequiers");
            demandeCheque.addError(erreur);
