...
public class CreationCROReceptionVirementParAgenceTrt extends Traitement {
	...
	public CreationCROReceptionVirementParAgenceTrt() {
	}
	...
	public IValueObject perform(IValueObject vo) {
		...
		try {
			...
			StringBuffer text = new StringBuffer("Erreur dans CreationCROReceptionVirementParAgenceTrt : ");
			text.append(e.toString());
			erreur.setCode("100");
			erreur.setDescription(text.toString());
			erreur.setKey("CreationCROReceptionVirementParAgenceTrt");
			virementVo.addError(erreur);
			logger.error("Erreur au niveau CreationCROReceptionVirementParAgenceTrt : ", e);
			virementVo.setMessageValidation("Probléme dans CreationCROReceptionVirementParAgenceTrt");
	...
	public void genCroText(ValueObject vo) {
		logger.info("starting CreationCROReceptionVirementParAgence method ");
		...
		this.setLibRefCro("RECEPTION VIREMENTS RECUS");
		...
		this.setCodStrcImpt(virementVo.getCodStrcRecp());
		...
		// Montant global des virements reçus inter/intra/SGMT par agence
		cro.append("MNT_GLB_VRC_AGE=");
