...
public class GetSituationMensInteretByCategCltCmd implements ICommande{
    public GetSituationMensInteretByCategCltCmd() {
    }
    /**
         * methode execute 
        ...
        public IValueObject execute(IValueObject vo) {
            ...
            Listes situationMensuelle =(Listes)placementService.getSituationMensuelleIntCategClt(paramDemandeDecision);
