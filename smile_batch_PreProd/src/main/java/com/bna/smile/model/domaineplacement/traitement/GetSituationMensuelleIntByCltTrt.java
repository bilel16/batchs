...
public class GetSituationMensuelleIntByCltTrt extends Traitement{
    public GetSituationMensuelleIntByCltTrt() {
    }
    ...
    List situationMensuelleDao = plcDao.getSituationMensuelleClientInt(codeTpceTpce,numPcePers);
