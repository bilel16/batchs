...
/**
 * classe pour la recherche d'un personnel
 * @author Mdimagh Med
 * @since 31/05/07
 */
public class GetPersonnelTrt extends Traitement {
    public GetPersonnelTrt() {
    }
    ...
    public IValueObject perform (IValueObject vo) {
        ...
        try {
            criteria.add(expression.eq("numMatrUser", personnel.getNumMatrUser() ));
            ...
            StringBuffer text = 
                new StringBuffer("Erreur dans GetPersonnelTrt : ");
            text.append(e.toString());
            erreur.setCode("200");
            erreur.setDescription(text.toString());
            erreur.setKey("GetPersonnelTrt");
