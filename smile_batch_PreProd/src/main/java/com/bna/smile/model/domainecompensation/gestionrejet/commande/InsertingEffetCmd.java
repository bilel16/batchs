 ...
 *
 */
public class InsertingEffetCmd {
	public InsertingEffetCmd() {
	}
	...
	public IValueObject execute(IValueObject vo) {
		 ...
		 **/
		// CompensationEffetVo compensationVo= (CompensationEffetVo)
		// gestionRejetService.insertingEffet(vo);

		CompensationEffetVo compensationVo = (CompensationEffetVo) gestionRejetService.insertingEffetACH(vo);
